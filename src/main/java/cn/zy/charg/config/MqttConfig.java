    ...
    public MessageHandler handler() {
        return new MessageHandler() {
            ...
            public void handleMessage(Message<?> message) throws MessagingException {
                ...
                switch (array[0]){
                    case "0": pileService.updatePlugStatue(pid,array[2]); break;
                    case "1": pileService.updateChargeStatue(pid,array[2]);break;
                    case "2" : pileService.updateChargeProcess(pid,array[2]);break;
                    case "3" : pileService.finishCharge(pid);break;
                    case "connect" : pileService.pileMqttConnect(pid);break;
                    default:break;
                }
            }
        };
